...
//    @BindView(R.id.requestDetailActivityGuideLine)
//    Guideline guideline;
...
//        guideline.setp
        ...
        if(requestUUID.equals(""))
            finish();
        //todo check with a wrong uuid what happen currently is crashing
        //requestUUID = "dsada";
        ...
        PatientRequestDetailStudentFoundFragment studentFragment = new PatientRequestDetailStudentFoundFragment();
