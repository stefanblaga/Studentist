...
//        add_request_toolbar.requestFocus();
//        add_request_toolbar.setFocusable(true);
//        categoryImageView.requestFocus();
    ...
    public void AddPatientRequest(View view) {
        ...
        if(telephoneNumber.equals("") || telephoneNumber.length() < 7)
        {
        ...
        PatientRequest request = new PatientRequest(patientName,requestInfo,typeOfRequest,userUid,requestUUID,currentDateTime, telephoneNumber);
